...
try
	...
	hold on;
	YLimits = ylim;
	line([lowThresh lowThresh], [YLimits(1) YLimits(2)], 'Color', 'm', 'LineWidth', 3);
	line([highThresh highThresh], [YLimits(1) YLimits(2)], 'Color', 'm', 'LineWidth', 3);
