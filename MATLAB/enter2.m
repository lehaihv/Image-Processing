...
hueTL1 = 0.5; %0.5; % Lower threshold for light blue
hueTH1 = 0.58; %0.535; %0.65; %0.642; %0.54; %0.535; % Upper threshold for dark blue
saturationTL1 = 0.3; saturationTH1 = 1;  %0.7 1
valueTL1 = 0.3; valueTH1 = 1; %0 1
...
binaryImage = bwareaopen(binaryImage, 6000); %60000
...
for k = 1:num_objs
    ...
    % Annotate the area, intensity, and dimensions at the centroid
    RGB_with_boxes = insertText(RGB_with_boxes, centroids(k, :), avgIntensityText, ...
        'FontSize', 15, 'BoxColor', 'yellow', 'TextColor', 'black', 'AnchorPoint', 'CenterBottom');
end
